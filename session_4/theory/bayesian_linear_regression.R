...
# @solution
x <- runif(n, -3, 3)  # Uniformly spaced inputs, shape (n,)
# end

# @exercise
# y_mean <- ...  # True linear relationship, shape (n,)
# @solution
y_mean <- 2 * x - 1 # True linear relationship, shape (n,)
# end

# @exercise
# noise <- ...  # Gaussian noise, shape (n,)
# @solution
noise <- rnorm(n, mean = 0, sd = sigma) # Gaussian noise, shape (n,)
# end

# @exercise
# y <- ...  # Observed outputs, shape (n,)
# @solution
y <- y_mean + noise # Observed outputs, shape (n,)
# end
